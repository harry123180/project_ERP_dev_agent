...
def get_requisition(current_user, request_order_no):
    ...
    try:
        ...
        if (current_user.role not in ['Admin', 'ProcurementMgr', 'Procurement'] and 
    ...
    try:
        ...
        for row in results:
            items.append({
                ...
                'questioned_by': row.questioned_by_name or f'User {row.questioned_by}',
